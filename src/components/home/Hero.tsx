      ...
      <div className="relative mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl mb-6">
            ...
            <span className="block" style={{ color: '#FFC300' }}>Innovation</span>
          </h1>
          <p className="mt-6 text-lg leading-8 text-gray-200 max-w-3xl mx-auto">
            ...
            that transform businesses and enhance people's lives. Our team of experts 
            delivers cutting-edge products and services that drive success.
          </p>
