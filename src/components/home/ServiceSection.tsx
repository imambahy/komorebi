          ...
          {services.length > 0 ? (
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-4">
              {services.map((service) => (
                <div key={service.objectId} className="flex flex-col bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                  {/* Service Image */}
                  {service.image && (
                    <div className="mb-4">
                      <img
                  ...
                  <dt className="text-lg font-semibold leading-7 mb-4" style={{ color: '#003566' }}>
                    {service.name}
                  </dt>
                  <dd className="flex flex-auto flex-col text-base leading-7 text-gray-600">
                    <p className="flex-auto mb-4">{service.description}</p>
                    {service.price && (
                      <p className="text-sm font-semibold mb-4" style={{ color: '#FFC300' }}>
                    ...
                    <p className="mt-auto">
                      <Link href="/services" className="text-sm font-semibold leading-6" style={{ color: '#FFC300' }}>
            ...
            <div className="text-center py-12">
              ...
              <p className="text-sm text-gray-400 mt-2">Debug: {services.length} services found</p>
            </div>
          )}
        </div>
      </div>
