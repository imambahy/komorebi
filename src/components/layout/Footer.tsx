      ...
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold mb-4" style={{ color: '#FFC300' }}>Komorebi</h3>
            <p className="text-gray-300 mb-4">
              Leading technology company dedicated to creating innovative solutions 
              that transform businesses and enhance people's lives.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-semibold mb-4" style={{ color: '#FFC300' }}>Quick Links</h3>
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-lg font-semibold mb-4" style={{ color: '#FFC300' }}>Contact</h3>
